...
console.log(`Initial array ${crr}`);
console.log(`Update array ${filterr}`);
...
let promise = new Promise((res, rej) => {
    let x = 200;
    if (x == 200) {
        document.getElementById("promise").style.color="green";
        document.getElementById("promise").style.fontSize="40px";
        res("Ok your code is running successfully")
    }
    else {
        document.getElementById("promise").style.color="red";
        document.getElementById("promise").style.fontSize="40px";
        rej("OOps!there is an error")
    }
});
promise.then(
